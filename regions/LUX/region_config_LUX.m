...
% Dates use dd/MM/yyyy and water-year boundaries.
    ...
    X.label = 'Daily';
    X.dt = 1;
    X.basins.universe = 56;
    X.basins.file = 'LUX_56_basins.txt';
...
function S = local_meteo_schema()
    ...
    S.profiles.daily.schema.file.pattern = 'CAMELS_LUX_hydromet_timeseries__daily_ID_{gauge02}.csv';
    ...
    S.profiles.hourly.schema.file.pattern = 'CAMELS_LUX_hydromet_timeseries_hourly_ID_{gauge02}.csv';
    ...
    S.profiles.quarter_hour.schema.file.pattern = 'CAMELS_LUX_hydromet_timeseries_15min_ID_{gauge02}.csv';
